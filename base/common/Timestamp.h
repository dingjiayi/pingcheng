...
// @param microSecondsZSinceEpoch_
...
{
    return lhs.microSecondsSinceEpoch() < rsh.microSecondsSinceEpoch();
}
...
{
    int64_t diff = hith.microSecondsSinceEpoch() - low.microSecondsSinceEpoch();
